...
const restaurant = {
  ...
  orderDelivery({ starterIndex = 1, mainIndex = 0, time, adress }) {
    console.log(
      `Order received! ${this.starterMenu[starterIndex]}and ${this.mainMenu[mainIndex]} will be deliver to ${adress} at ${time}`
    );
  },

  orderPasta(ing1, ing2, ing3) {
    console.log(
      `Here is your delicipus pasta with ${ing1}, ${ing2} and ${ing3}. `
    );
  },
...
console.log(maskCreditCard(4656562624565));
console.log(maskCreditCard('6555626565626566464'));
...
const announcement =
  'All passengers come o boarding door 23. Boarding door 23!';
...
//Array
const users = [{ name: 'mucahit', email: 'hello@mucahit.io' }];
//const users = [];
...
7. The team with the lower odd is more likely to win. Print to the console which team is more likely to win, WITHOUT using an if/else statement or the 
ternary operator.
...
console.log(0 && 'Mucahit');
console.log(7 && 'Mucahit');

console.log('Hello' && 23 && null && 'Mucahit');
